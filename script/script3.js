function rps(str) {
    ...
    if (str === 'Rock' && arr[rand] === 'Scissors') {
        ...
        return (`“Player selected ${str}. CPU selected ${arr[rand]}. Player won”`);
    }
    else if (str === 'Rock' && arr[rand] === 'Paper') {
        console.log(str, arr[rand]);
        return (`“Player selected ${str}. CPU selected ${arr[rand]}. CPU won”`);
    }
        ...
        console.log(str, arr[rand]);
        return (`Player and CPU both selected Paper. Friendship won`);
    }
}
